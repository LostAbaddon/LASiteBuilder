...
这种无法避免也无法区分的特性，决定了**即便一个理论与现象符合得再好它也可能是错的，以及一个理论与现象符合得再不好它也依然有可能是正确的**。
...
在他们看来，只要数学上是自洽的，那理论就是科学的。但我们都知道，数学所要研究的对象是远比自然界更广阔的抽象领域中的对象，它的自洽性只能表示数学上的有效性，但不不能表示它真的描述了我们所身处的自然界——我们完全可以为阴阳五行与奇异博士建立一套逻辑上自洽的形式系统，但它和我们所处世界的联系仅在于，它到底画在哪一本漫画书上了。
