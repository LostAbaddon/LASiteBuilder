<template>
	...
	<div class="infomation markup">
		...
		<p>这里的大部分物理量都是从无穷远观测者看来的，且“表面引力”指的是对应的牛顿引力大小，因为在广义相对论中任意黑洞的表面引力都是无穷大。同理，“等效密度”值得也是牛顿值。而“落入奇点所用时间”是指从视界面开始下落的自由落体者的随动坐标系测量而得的时间，并不是无穷远观测者的观测值，在无穷远观测者看来落入黑洞所用时间为无限长。</p>
	</div>
